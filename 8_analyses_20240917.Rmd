...
fig1<-grid.arrange(
  arrangeGrob(
    ...
    arrangeGrob(fig1_7,fig1_8,ncol=2,
                left=textGrob("      Total number\n      of seeds",rot=90,
                              gp=gpar(fontsize=12,fontfamily="serif"),
                              just="center")),
    nrow = 4,
    bottom=arrangeGrob(
      textGrob("                    Temperature at planting site (ºC)",
               gp=gpar(fontsize=12,fontfamily="serif"),just="center"),
      textGrob("              Temperature difference (ºC)",
               gp=gpar(fontsize=12,fontfamily="serif"),just="center"),
      ncol = 2,
...
## Differences in fitness components among years - needed?
...
App2<-grid.arrange(
  arrangeGrob(
    arrangeGrob(App2_1,App2_2,ncol=2,
                left=textGrob("      Probability\n      of survival",rot=90,
                              gp=gpar(fontsize=12,fontfamily="serif"),
                              just="center")),
    arrangeGrob(App2_3,App2_4,ncol=2,
                left=textGrob("      Probability\n      of flowering",rot=90,
                              gp=gpar(fontsize=12,fontfamily="serif"),
                              just="center")),
    arrangeGrob(App2_5,App2_6,ncol=2,
                left=textGrob("      Probability\n      of fruiting",rot=90,
                              gp=gpar(fontsize=12,fontfamily="serif"),
                              just="center")),
    arrangeGrob(App2_7,App2_8,ncol=2,
                left=textGrob("      Total number\n      of seeds",rot=90,
                              gp=gpar(fontsize=12,fontfamily="serif"),
                              just="center")),
    nrow = 4,
...
ggsave(file="output/figures/App2.tiff", plot=App2,width=6,height=8,dpi=300,
       compression="lzw")
```
...
## Appendix 3: Fit distributions to n seeds
...
App3<-grid.arrange(
  ...
  ggplot(df_nb,aes(x=value,fill=group,color=group)) +
    ...
    geom_text(data=annotations_nb,aes(x=x,y=y,label=label), 
              inherit.aes=FALSE,hjust=1,vjust=1,family="Times New Roman"),
  ncol=1)
ggsave(file="output/figures/App3.tiff", plot=App3,width=6,height=8,dpi=300,
       compression="lzw")
```
...
fig2<-grid.arrange(
  ggplot()+
    ...
    xlab("Temperature at planting site (ºC)")+ylab(NULL)+
    my_theme(),
  ggplot()+
    geom_point(data=data_transplants%>%filter(fruiting==1),
               aes(x=temp_diff,y=n_tot_seed,color=year),size=1,alpha=0.2)+
    ...
    xlab("Temperature difference (ºC)")+ylab(NULL)+
    my_theme(),
  ncol=2,left=textGrob("     Predicted fitness",rot=90,
                       gp=gpar(fontsize=16,fontfamily="serif"),just="center"))
ggsave(file="output/figures/fig2.tiff", plot=fig2,width=6,height=3,dpi=300,
       compression="lzw")
```
...
ggsave(file="output/figures/fig2_nopoints.tiff",
       plot=fig2_nopoints,width=6,height=3,dpi=300,compression="lzw")
```

# Aster both vars, plot as random (App 4)
...
# Aster single vars, plot as fixed (App 5)
...
App6<-grid.arrange(
  ...
  ncol=2,left=textGrob("Predicted fitness",rot=90,
                       gp=gpar(fontsize=16,fontfamily="serif"),just="center"))
ggsave(file="output/figures/App6.tiff", plot=App6,width=6,height=3,dpi=300,
       compression="lzw")
```

```{r}
App6_nopoints<-grid.arrange(
  ggplot()+
    #geom_point(data=data_transplants%>%filter(fruiting==1),
    #           aes(x=temp,y=n_tot_seed,color=year),size=1.5,alpha=0.2)+
    # 2022 temp
  ...
  ncol=2,left=textGrob("Predicted fitness",rot=90,
                       gp=gpar(fontsize=16,fontfamily="serif"),just="center"))
ggsave(file="output/figures/App6_nopoints.tiff",plot=App6_nopoints,
       width=6,height=3,dpi=300,compression="lzw")
```

# Aster single vars, plot as random (App 7)
...
```{r}
aster22_temp_pois <- reaster(fixed=resp ~ varb+seeds:(temp_s+poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
                                  root, data = redata22)
...
```{r}
aster22_temp_pois_1 <- reaster(fixed=resp ~ varb+seeds:(poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
                                  root, data = redata22)
...
```{r}
anova(aster22_temp_pois_1,aster22_temp_pois)
```

Testing the significance of seeds:poll_type

```{r}
aster22_temp_pois_2 <- reaster(fixed=resp ~ varb+seeds:(temp_s), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
                                  root, data = redata22)
...
```{r}
anova(aster22_temp_pois_2,aster22_temp_pois)
```
...
```{r}
aster23_temp_pois <- reaster(fixed=resp ~ varb+seeds:(temp_s+poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
                                  root, data = redata23)
...
```{r}
aster23_temp_pois_1 <- reaster(fixed=resp ~ varb+seeds:(poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
                                  root, data = redata23)
...
```{r}
anova(aster23_temp_pois_1,aster23_temp_pois)
```

Testing the significance of seeds:poll_type

```{r}
aster23_temp_pois_2 <- reaster(fixed=resp ~ varb+seeds:(temp_s), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
                                  root, data = redata23)
...
```{r}
anova(aster23_temp_pois_2,aster23_temp_pois)
```
...
```{r}
aster22_temp_diff_pois <- reaster(fixed=resp ~ varb+seeds:(temp_diff_s+
                                                             I(temp_diff_s^2)+
                                                             poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
...
```{r}
summary(aster22_temp_diff_pois)
```
...
```{r}
aster22_temp_diff_pois_1 <- reaster(fixed=resp ~ varb+seeds:(I(temp_diff_s^2)+
                                                               poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
...
```{r}
anova(aster22_temp_diff_pois_1,aster22_temp_diff_pois)
```

Testing the significance of seeds:I(temp_diff_s^2)

```{r}
aster22_temp_diff_pois_2 <- reaster(fixed=resp ~ varb+seeds:(temp_diff_s+
                                                               poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
...
```{r}
anova(aster22_temp_diff_pois_2,aster22_temp_diff_pois)
```

Testing the significance of seeds:poll_type

```{r}
aster22_temp_diff_pois_3 <- reaster(fixed=resp ~ varb+seeds:(temp_diff+
                                                               I(temp_diff_s^2)), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
...
```{r}
anova(aster22_temp_diff_pois_3,aster22_temp_diff_pois)
```
...
```{r}
aster23_temp_diff_pois <- reaster(fixed=resp ~ varb+seeds:(temp_diff_s+
                                                             I(temp_diff_s^2)+
                                                             poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
...
```{r}
summary(aster23_temp_diff_pois)
```
...
```{r}
aster23_temp_diff_pois_1 <- reaster(fixed=resp ~ varb+seeds:(I(temp_diff_s^2)+
                                                               poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
...
```{r}
anova(aster23_temp_diff_pois_1,aster23_temp_diff_pois)
```

Testing the significance of seeds:I(temp_diff_s^2)

```{r}
aster23_temp_diff_pois_2 <- reaster(fixed=resp ~ varb+seeds:(temp_diff_s+
                                                               poll_type), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
...
```{r}
anova(aster23_temp_diff_pois_2,aster23_temp_diff_pois)
```

Testing the significance of seeds:poll_type

```{r}
aster23_temp_diff_pois_3 <- reaster(fixed=resp ~ varb+seeds:(temp_diff+
                                                               I(temp_diff_s^2)), 
                                  random=list(plot= ~0 + seeds:plot), 
                                  pred, fam, famlist=famlist1, varb,
                                  idvar=as.numeric(unique_id), 
...
```{r}
anova(aster23_temp_diff_pois_3,aster23_temp_diff_pois)
```

# TO DO: Aster models plot as fixed with FFD
...
```{r}
aster22_nb_plotfi_FFD <- aster(resp ~ varb+seeds:(temp_s+temp_diff_s+
                                                  I(temp_diff_s^2)+FFD_corr_s+
                                                  poll_type+plot), 
                 pred, fam, famlist=famlist, varb, idvar=as.numeric(unique_id), 
                 root, data = redata22)
```
